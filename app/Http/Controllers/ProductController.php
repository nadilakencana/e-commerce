...
class ProductController extends Controller
{
    ...
    public function postProduct(Request $request){
        ...
        $request->validate([
            ...
            'image' => 'required|image|mimes:png,jpg,jpeg,gif,svg|max:50000',
        ]);
    ...
    public function UpdateProduct(Request $request , $id){
        $request->validate([
            ...
            'deskripsi' => 'required',
            'id_category' => 'required',
            'image' => 'image|mimes:png,jpg,jpeg,gif,svg|max:50000',
        ]);
    ...
    public function deleteProduct($id){
        ...
        return redirect()->back()->with('success', 'Data has been successfully to delete');
    }
