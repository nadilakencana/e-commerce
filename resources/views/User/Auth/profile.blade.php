...
<div class="section profile">
    ...
    <div class="header-profile d-flex gap-5 align-items-center">
        <div class="col-lg-3 col-sm-12">
            <div class="image-profile" style="width: 200px;height: 200px;">
                @if($User->image === null)
                <img src="{{ asset('assets/images/faces/6.jpg') }}" alt="" class="img-fluid"
                    style="border-radius: 100px">
                @else
                <img src="{{ asset('assets/images/profile_user/'.$User->image) }}" alt="" class="img-fluid"
                    style="border-radius: 100px">
                @endif
            </div>
        </div>
    ...
    <div class="pannel-profile pt-5 border-bottom">
        <div class="list-pannel d-flex gap-3 mb-3 mt-3">
            ...
            <a href="{{ route('logout-user') }}">
                <div class="btn btn-dark">Logout</div>
            </a>
        </div>
    </div>
    <div class="tab-panel">
            ...
            <form action="{{route('update-user', $User->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group position-relative has-icon-left mb-4">
                    <input type="email" name="email"
                        class="form-control form-control-xl @error ('email') is-invalid @enderror " placeholder="Email" value="{{$User->email}}">
                ...
                <div class="form-group position-relative has-icon-left mb-4">
                    <input type="number" name="no_hp"
                        ...
                        placeholder="Your Phone Number" value="{{$User->no_hp}}">
                ...
                <div class="form-group position-relative has-icon-left mb-4">
                    <textarea type="text" name="alamat"
                        ...
                        placeholder="Your Addres">{{$User->alamat}}</textarea>
        ...
        <div class="panel mt-4" data-panel="panel2" panel-order="2">
            ...
            <div class="content-history d-flex flex-grow gap-3">
                ...
                <div class="card p-3">
                    ...
                    <div class="footer-card text-end mt-4">
                        <div class="btn btn-dark detail" data-bs-toggle="modal"
                            data-bs-target="#exampleModal-{{ $order->id }}">Detail Order</div>
                    </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="product">
                                                        ...
                                                        <div class="image-pro-detail" style=" width: 150px;height: 114px;">
                                                            <img src="{{ asset('assets/images/product/'. $detail->product->image) }}" alt="" class="img-fluid" style="height: 100%;border-radius:10px;">
                                                        </div>
                                                        <div class="variasi">
                                                            <div class="var-pro-detail d-flex gap-3">
                                                                <label for="">Color</label>
                                                                <div class="dt-var">: {{ $detail->warna->name }}</div>
                                                            </div>
                                                            <div class="var-pro-detail d-flex gap-3">
                                                                <label for="">Size</label>
                                                                <div class="dt-var">: {{ $detail->ukuran->ukuran }}</div>
                                                            </div>
                                                        </div>
...
<script>
    $(()=>{
        $('.box-panel').on('click', function(){
            ...
            $('.box-panel').removeClass('active-panel');
