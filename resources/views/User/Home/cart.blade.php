                            ...
                            @foreach ($carts as $k => $cart)
                                <td class="item-cart" >
                                    <div class="data-product" >
                                        ...
                                        <div class="image-pro-cart" style="width: 150px;height: 150px;">
                                            <img src="{{ asset('assets/images/product/'.$cart['image']) }}" alt="" class="img-fluid" style="object-fit: cover;height:100%;">
                                        </div>
                                        <div class="varian d-flex gap-3 mt-3">
                                            <div class="varian-color">
                                                <label for="">Color</label>
                                                <div class="dt-color-va">:{{ $cart['warna']}}</div>
                                            </div>
                                            <div class="varian-size">
                                                <label for="">Size</label>
                                                <div class="dt-size-va">: {{ $cart['ukuran'] }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </td>
