...
<body>
    ...
    <div class="container">
        <div class="btn btn-danger print-invoice mt-3">Print Invoice</div>
            ...
            <div class="detail-order">
                <table style="width: 100%">
                    ...
                    <tbody>
                        ...
                        <tr style="border-bottom: 1px solid rgba(145, 144, 144, 0.822)">
                            <td>
                            ...
                            <td>{{ $detail->qty }}</td>
                            <td style="text-align: end">Rp.{{ number_format($detail->harga_product, 0, ',', '.') }}</td>
                            <td style="text-align: end">Rp.{{ number_format($detail->total_item, 0, ',', '.') }}</td>
                        </tr>
                ...
                <div class="footer-tabel border-bottom mt-1 d-flex flex-column align-items-end">
                    ...
                    <div class="total-invoice d-flex gap-3" style="width: 30%">
                        ...
                        <span>:</span>
                        <div class="dt-total text-end w-50">Rp. {{ number_format($order->sub_total, 0, ',', '.')  }}</div>
                    </div>
                    <div class="total-invoice d-flex gap-3" style="width: 30%">
